  ...
  actualizarformularios(nuevoFormulario){
    ...
    this.setState({data_editada:false});
      ...
      //ACTUALIZO ESTADO DEL AREA DE EDICION
       ...
       this.setState({caso_taskId:nuevoFormulario.formulario[0].ficha.datos_ficha.datos_ficha.caso_taskId});
       this.setState({caso_instance:nuevoFormulario.formulario[0].ficha.datos_ficha.datos_ficha.caso_instance});
