...
enviarGestionAgenda = (event) => {
    ...
    if(event.data.select=="agendamiento_propio"){
        ...
        items_doc_data["follow_date"]=event.data.fechaDeAgendamiento.slice(0, 10)
        items_doc_data["folow_time"]=event.data.fechaDeAgendamiento.slice(11, 19)
    ...
    const transaccion={
                        "tx":"FG0",
                        "face_user":"3099",//this.props.anexo,
                        "destino":"test",
                        "tx_version" : "0.0",
                        "origen":"face",
                        //"accion":"",
                        "caso": {
                            "caso_gestiones": Number(this.props.edicion[0].ficha.datos_ficha.caso_gestiones),
                            "caso_id":this.props.edicion[0].ficha.caso_ES,
                            "caso_TaskId":"a870b867-f050-11e9-a702-0aa9e46cbd30", //this.props.edicion[0].ficha.caso_TaskId,
                            "caso_instance":"9756d1f9-f050-11e9-a702-0aa9e46cbd30"
                        },
